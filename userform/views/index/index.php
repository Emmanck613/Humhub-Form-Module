...
\ricit\humhub\modules\userform\assets\Assets::register($this);

$displayName = (Yii::$app->user->isGuest) ? Yii::t('UserformModule.base', 'Guest') : Yii::$app->user->getIdentity()->displayName;

// Add some configuration to our js module
$this->registerJsConfig("userform", [
    'username' => (Yii::$app->user->isGuest) ? $displayName : Yii::$app->user->getIdentity()->username,
    'text' => [
        'hello' => Yii::t('UserformModule.base', 'Hi there {name}!', ["name" => $displayName])
    ]
    ]);
?>

<div class="panel-heading"><strong>Userform</strong> <?= Yii::t('UserformModule.base', 'overview') ?></div>

<div class="panel-body">
    <p><?= Yii::t('UserformModule.base', 'Hello World!') ?></p>
